...
- **Area** design system · **Effort** S · **Score** not in the judged pool; placed by the verification pass · Marc supplies the secret · **Shipped** 2026-09-16 (pin `^4.0.1` and the embed); still open: the chart-path smoke check in the root package, and the Dependabot secret (Marc)
...
- **Area** agent · **Effort** M · **Score** 3.93 · corrected
