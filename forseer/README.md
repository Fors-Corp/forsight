...
| `budget forecast` | Holt's linear method, projected to 100% with the ETS(A,A,N) interval for the distance being projected | "60% consumed" is a fact about the past; when it runs out is the actionable question | **ErrorBudget** |
